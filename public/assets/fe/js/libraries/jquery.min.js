! function(e, t) {
    ...
    function r(e, n, r) {
        if (r === t && 1 === e.nodeType) {
            ...
            if ("string" == typeof(r = e.getAttribute(i))) {
                try {
                    r = "true" === r || "false" !== r && ("null" === r ? null : +r + "" === r ? +r : ue.test(r) ? K.parseJSON(r) : r)
                } catch (e) {}
                K.data(e, n, r)
            } else r = t
        }
    ...
    function u(e, t, n) {
        ...
        if ("string" == typeof t) {
            ...
            if (Ae.test(t)) return K.filter(t, r, !n);
            t = K.filter(t, r)
        }
    ...
    function v(e, t) {
        for (var n, r, i = [], o = 0, a = e.length; o < a; o++) n = e[o], n.style && (i[o] = K._data(n, "olddisplay"), t ? (!i[o] && "none" === n.style.display && (n.style.display = ""), "" === n.style.display && y(n) && (i[o] = K._data(n, "olddisplay", T(n.nodeName)))) : (r = Ue(n, "display"), !i[o] && "none" !== r && K._data(n, "olddisplay", r)));
    ...
    function x(e, t, n, r) {
        for (var i = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, o = 0; i < 4; i += 2) "margin" === n && (o += K.css(e, n + at[i], !0)), r ? ("content" === n && (o -= parseFloat(Ue(e, "padding" + at[i])) || 0), "margin" !== n && (o -= parseFloat(Ue(e, "border" + at[i] + "Width")) || 0)) : (o += parseFloat(Ue(e, "padding" + at[i])) || 0, "padding" !== n && (o += parseFloat(Ue(e, "border" + at[i] + "Width")) || 0));
        return o
    }
    ...
    function w(e, t, n) {
        ...
        if (r <= 0 || null == r) {
            if (r = Ue(e, t), (r < 0 || null == r) && (r = e.style[t]), tt.test(r)) return r;
    ...
    function T(e) {
        ...
        var t = K("<" + e + ">").appendTo(R.body),
            n = t.css("display");
        return t.remove(), "none" !== n && "" !== n || (Ye = R.body.appendChild(Ye || K.extend(R.createElement("iframe"), {
            frameBorder: 0,
            width: 0,
            height: 0
        })), Ve && Ye.createElement || (Ve = (Ye.contentWindow || Ye.contentDocument).document, Ve.write("<!doctype html><html><body>"), Ve.close()), t = Ve.body.appendChild(Ve.createElement(e)), n = Ue(t, "display"), R.body.removeChild(Ye)), rt[e] = n, n
    }

    function N(e, t, n, r) {
        var i;
        if (K.isArray(t)) K.each(t, function(t, i) {
            n || ut.test(e) ? r(e, i) : N(e + "[" + ("object" == typeof i ? t : "") + "]", i, n, r)
        });
    ...
    function k(e, n, r, i, o, a) {
        ...
        for (var s, l = e[o], u = 0, c = l ? l.length : 0, f = e === xt; u < c && (f || !s); u++) "string" == typeof(s = l[u](n, r, i)) && (!f || a[s] ? s = t : (n.dataTypes.unshift(s), s = k(e, n, r, i, s, a)));
    ...
    function H(e, t) {
        K.each(t, function(t, n) {
            for (var r = (_t[t] || []).concat(_t["*"]), i = 0, o = r.length; i < o; i++)
    ...
    function F(e, t, n) {
        var r, i = 0,
            ...
            s = function() {
                for (var t = Dt || L(), n = Math.max(0, l.startTime + l.duration - t), r = n / l.duration || 0, i = 1 - r, o = 0, s = l.tweens.length; o < s; o++) l.tweens[o].run(i);
        ...
        for (M(u, l.opts.specialEasing); i < o; i++)
            if (r = Ot[i].call(l, e, u, l.opts)) return r;
    ...
    var W, P, R = e.document,
        ...
        ae = function() {
            R.addEventListener ? (R.removeEventListener("DOMContentLoaded", ae, !1), K.ready()) : "complete" === R.readyState && (R.detachEvent("onreadystatechange", ae), K.ready())
        },
        se = {};
    K.fn = K.prototype = {
        constructor: K,
        init: function(e, n, r) {
            ...
            if ("string" == typeof e) {
                if ((i = "<" === e.charAt(0) && ">" === e.charAt(e.length - 1) && e.length >= 3 ? [null, e, null] : ne.exec(e)) && (i[1] || !n)) {
                    if (i[1]) return n = n instanceof K ? n[0] : n, a = n && n.nodeType ? n.ownerDocument || n : R, e = K.parseHTML(i[1], a, !0), re.test(i[1]) && K.isPlainObject(n) && this.attr.call(e, n, !0), K.merge(this, e);
        ...
        ready: function(e) {
            if (!0 === e ? !--K.readyWait : !K.isReady) {
                ...
                K.isReady = !0, !0 !== e && --K.readyWait > 0 || (P.resolveWith(R, [K]), K.fn.trigger && K(R).trigger("ready").off("ready"))
            }
        },
        ...
        type: function(e) {
            return null == e ? String(e) : se[J.call(e)] || "object"
        },
        ...
        parseHTML: function(e, t, n) {
            var r;
            return e && "string" == typeof e ? ("boolean" == typeof t && (n = t, t = 0), t = t || R, (r = re.exec(e)) ? [t.createElement(r[1])] : (r = K.buildFragment([e], t, n ? null : []), K.merge([], (r.cacheable ? K.clone(r.fragment) : r.fragment).childNodes))) : null
        },
        parseJSON: function(t) {
            return t && "string" == typeof t ? (t = K.trim(t), e.JSON && e.JSON.parse ? e.JSON.parse(t) : ie.test(t.replace(/\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g, "@").replace(/"[^"\\\r\n]*"|true|false|null|-?(?:\d\d*\.|)\d+(?:[eE][\-+]?\d+|)/g, "]").replace(/(?:^|:|,)(?:\s*\[)+/g, "")) ? new Function("return " + t)() : void K.error("Invalid JSON: " + t)) : null
        },
        parseXML: function(n) {
            var r, i;
        ...
        if (!P)
            ...
            else if (R.addEventListener) R.addEventListener("DOMContentLoaded", ae, !1), e.addEventListener("load", K.ready, !1);
        else {
            R.attachEvent("onreadystatechange", ae), e.attachEvent("onload", K.ready);
            var n = !1;
            try {
    ...
    K.Callbacks = function(e) {
        e = "string" == typeof e ? le[e] || n(e) : K.extend({}, e);
        var r, i, o, a, s, l, u = [],
            c = !e.once && [],
            f = function(t) {
        ...
        return K(function() {
            ...
            s && (n = R.createElement("div"), n.style.cssText = "visibility:hidden;border:0;width:0;height:0;position:static;top:0;margin-top:1px", s.insertBefore(n, s.firstChild), r = R.createElement("div"), n.appendChild(r), r.innerHTML = "<table><tr><td></td><td>t</td></tr></table>", i = r.getElementsByTagName("td"), i[0].style.cssText = "padding:0;margin:0;border:0;display:none", c = 0 === i[0].offsetHeight, i[0].style.display = "", i[1].style.display = "none", t.reliableHiddenOffsets = c && 0 === i[0].offsetHeight, r.innerHTML = "", r.style.cssText = "box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;position:absolute;top:1%;", t.boxSizing = 4 === r.offsetWidth, t.doesNotIncludeMarginInBodyOffset = 1 !== s.offsetTop, e.getComputedStyle && (t.pixelPosition = "1%" !== (e.getComputedStyle(r, null) || {}).top, t.boxSizingReliable = "4px" === (e.getComputedStyle(r, null) || {
                width: "4px"
            }).width, o = R.createElement("div"), o.style.cssText = r.style.cssText = a, o.style.marginRight = o.style.width = "0", r.style.width = "1px", r.appendChild(o), t.reliableMarginRight = !parseFloat((e.getComputedStyle(o, null) || {}).marginRight)), void 0 !== r.style.zoom && (r.innerHTML = "", r.style.cssText = a + "width:1px;padding:1px;display:inline;zoom:1", t.inlineBlockNeedsLayout = 3 === r.offsetWidth, r.style.display = "block", r.style.overflow = "visible", r.innerHTML = "<div></div>", r.firstChild.style.width = "5px", t.shrinkWrapBlocks = 3 !== r.offsetWidth, n.style.zoom = 1), s.removeChild(n), n = r = i = o = null)
        ...
        data: function(e, n, r, i) {
            if (K.acceptData(e)) {
                var o, a, s = K.expando,
                    ...
                    c = u ? K.cache : e,
                    f = u ? e[s] : e[s] && s;
                if (f && c[f] && (i || c[f].data) || !l || r !== t) return f || (u ? e[s] = f = K.deletedIds.pop() || K.guid++ : f = s), c[f] || (c[f] = {}, u || (c[f].toJSON = K.noop)), "object" != typeof n && "function" != typeof n || (i ? c[f] = K.extend(c[f], n) : c[f].data = K.extend(c[f].data, n)), o = c[f], i || (o.data || (o.data = {}), o = o.data), r !== t && (o[K.camelCase(n)] = r), l ? null == (a = o[n]) && (a = o[K.camelCase(n)]) : a = o, a
            }
        },
    ...
    K.fn.extend({
            ...
            if (e && "string" == typeof e || e === t)
                for (n = (e || "").split(te), s = 0, l = this.length; s < l; s++)
                    if (i = this[s], 1 === i.nodeType && i.className) {
                        for (r = (" " + i.className + " ").replace(he, " "), o = 0, a = n.length; o < a; o++)
        ...
        val: function(e) {
            var n, r, i, o = this[0]; {
                ...
                if (o) return n = K.valHooks[o.type] || K.valHooks[o.nodeName.toLowerCase()], n && "get" in n && (r = n.get(o, "value")) !== t ? r : (r = o.value, "string" == typeof r ? r.replace(/\r/g, "") : null == r ? "" : r)
            }
        }
    }), K.extend({
        valHooks: {
        ...
        attr: function(e, n, r, i) {
            ...
            if (e && 3 !== l && 8 !== l && 2 !== l) return i && K.isFunction(K.fn[n]) ? K(e)[n](r) : void 0 === e.getAttribute ? K.prop(e, n, r) : ((s = 1 !== l || !K.isXMLDoc(e)) && (n = n.toLowerCase(), a = K.attrHooks[n] || (ve.test(n) ? pe : fe)), r !== t ? null === r ? void K.removeAttr(e, n) : a && "set" in a && s && (o = a.set(e, r, n)) !== t ? o : (e.setAttribute(n, r + ""), r) : a && "get" in a && s && null !== (o = a.get(e, n)) ? o : (o = e.getAttribute(n), null === o ? t : o))
        },
        removeAttr: function(e, t) {
            var n, r, i, o, a = 0;
            if (t && 1 === e.nodeType)
                for (r = t.split(te); a < r.length; a++)(i = r[a]) && (n = K.propFix[i] || i, o = ve.test(i), o || K.attr(e, i, ""), e.removeAttribute(be ? i : n), o && n in e && (e[n] = !1))
        },
        attrHooks: {
            type: {
                set: function(e, t) {
                    if (ge.test(e.nodeName) && e.parentNode) K.error("type property can't be changed");
            ...
            value: {
                get: function(e, t) {
                    return fe && K.nodeName(e, "button") ? fe.get(e, t) : t in e ? e.value : null
                },
                set: function(e, t, n) {
                    if (fe && K.nodeName(e, "button")) return fe.set(e, t, n);
                    e.value = t
                }
            }
        },
        ...
        get: function(e, n) {
            var r;
            return r = e.getAttributeNode(n), r && (de[n] ? "" !== r.value : r.specified) ? r.value : t
        },
        set: function(e, t, n) {
    ...
    var xe = /^(?:textarea|input|select)$/i,
        ...
        ke = function(e) {
            return K.event.special.hover ? e : e.replace(/(?:^|\s)hover(\.\S+|)\b/, "mouseenter$1 mouseleave$1")
        };
    K.event = {
            add: function(e, n, r, i, o) {
                ...
                if (3 !== e.nodeType && 8 !== e.nodeType && n && r && (a = K._data(e))) {
                    for (r.handler && (h = r, r = h.handler, o = h.selector), r.guid || (r.guid = K.guid++), l = a.events, l || (a.events = l = {}), s = a.handle, s || (a.handle = s = function(e) {
                        ...
                        }, s.elem = e), n = K.trim(ke(n)).split(" "), u = 0; u < n.length; u++) c = we.exec(n[u]) || [], f = c[1], p = (c[2] || "").split(".").sort(), m = K.event.special[f] || {}, f = (o ? m.delegateType : m.bindType) || f, m = K.event.special[f] || {}, d = K.extend({
                        type: f,
                        origType: c[1],
                        data: i,
                        handler: r,
            ...
            remove: function(e, t, n, r, i) {
                ...
                if (m && (p = m.events)) {
                    for (t = K.trim(ke(t || "")).split(" "), o = 0; o < t.length; o++)
                        if (a = we.exec(t[o]) || [], s = l = a[1], u = a[2], s) {
            ...
            trigger: function(n, r, i, o) {
                if (!i || 3 !== i.nodeType && 8 !== i.nodeType) {
                    var a, s, l, u, c, f, p, d, h, g, m = n.type || n,
                        y = [];
                    if (Ce.test(m + K.event.triggered)) return;
                    ...
                    if (h = [
                        ...
                        for (g = p.delegateType || m, u = Ce.test(g + m) ? i : i.parentNode, c = i; u; u = u.parentNode) h.push([u, g]), c = u;
                        c === (i.ownerDocument || R) && h.push([c.defaultView || c.parentWindow || e, g])
                    }
                    for (l = 0; l < h.length && !n.isPropagationStopped(); l++) u = h[l][0], n.type = h[l][1], d = (K._data(u, "events") || {})[n.type] && K._data(u, "handle"), d && d.apply(u, r), (d = f && u[f]) && K.acceptData(u) && d.apply && !1 === d.apply(u, r) && n.preventDefault();
            ...
            setup: function() {
                if (xe.test(this.nodeName)) return "checkbox" !== this.type && "radio" !== this.type || (K.event.add(this, "propertychange._change", function(e) {
                ...
                K.event.add(this, "beforeactivate._change", function(e) {
                    var t = e.target;
                    xe.test(t.nodeName) && !K._data(t, "_change_attached") && (K.event.add(t, "change._change", function(e) {
            ...
            teardown: function() {
                return K.event.remove(this, "._change"), !xe.test(this.nodeName)
            }
            ...
            }, Te.test(t) && (K.event.fixHooks[t] = K.event.keyHooks), Ne.test(t) && (K.event.fixHooks[t] = K.event.mouseHooks)
        }),
        function(e, t) {
            function n(e, t, n, r) {
                n = n || [], t = t || L;
                ...
                if (!(a = w(t)) && !r && (i = te.exec(e)))
                    if (s = i[1]) {
                        ...
                        if ((s = i[3]) && fe && t.getElementsByClassName) return _.apply(n, q.call(t.getElementsByClassName(s), 0)), n
                    }
            ...
            function s(e, t) {
                ...
                for (s = e, l = [], u = b.preFilter; s;) {
                    r && !(i = Q.exec(s)) || (i && (s = s.slice(i[0].length) || s), l.push(o = [])), r = !1, (i = Z.exec(s)) && (o.push(r = new D(i.shift())), s = s.slice(r.length), r.type = i[0].replace(G, " "));
                    for (a in b.filter)(i = ae[a].exec(s)) && (!u[a] || (i = u[a](i))) && (o.push(r = new D(i.shift())), s = s.slice(r.length), r.type = a, r.matches = i);
                    if (!r) break
                }
            ...
            function g(e, t, n, r, i) {
                ...
                if (!r && 1 === f.length) {
                    if (a = f[0] = f[0].slice(0), a.length > 2 && "ID" === (l = a[0]).type && 9 === t.nodeType && !i && b.relative[a[1].type]) {
                        if (!(t = b.find.ID(l.matches[0].replace(oe, ""), t, i)[0])) return n;
                        e = e.slice(a.shift().length)
                    }
                    for (o = ae.POS.test(e) ? -1 : a.length - 1; o >= 0 && (l = a[o], !b.relative[u = l.type]); o--)
                        if ((c = b.find[u]) && (r = c(l.matches[0].replace(oe, ""), ne.test(a[0].type) && t.parentNode || t, i))) {
                            if (a.splice(o, 1), !(e = r.length && a.join(""))) return _.apply(n, q.call(r, 0)), n;
                            break
                        }
                }
                return N(e, f)(r, t, i, n, ne.test(e)), n
            }
            ...
            n.matches = function(e, t) {
                ...
                var n, r = w(e);
                return r || (t = t.toLowerCase()), (n = b.attrHandle[t]) ? n(e) : r || ce ? e.getAttribute(t) : (n = e.getAttributeNode(t), n ? "boolean" == typeof e[t] ? e[t] ? t : null : n.specified ? n.value : null : null)
            }, b = n.selectors = {
                cacheLength: 50,
                createPseudo: W,
                match: ae,
                ...
                find: {
                    ID: v ? function(e, t, n) {
                        ...
                        if (typeof t.getElementById !== A && !n) {
                            var r = t.getElementById(e);
                            return r ? r.id === e || typeof r.getAttributeNode !== A && r.getAttributeNode("id").value === e ? [r] : void 0 : []
                        }
                    },
                    TAG: le ? function(e, t) {
                ...
                preFilter: {
                    ...
                    PSEUDO: function(e) {
                        var t, n;
                        return ae.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[3] : (t = e[4]) && (ee.test(t) && (n = s(t, !0)) && (n = t.indexOf(")", t.length - n) - t.length) && (t = t.slice(0, n), e[0] = e[0].slice(0, n)), e[2] = t), e.slice(0, 3))
                    }
                },
                filter: {
                    ID: v ? function(e) {
                ...
                var e, t = g,
                    r = [":focus"],
                    i = [":active"],
                    o = H.matchesSelector || H.mozMatchesSelector || H.webkitMatchesSelector || H.oMatchesSelector || H.msMatchesSelector;
                se(function(e) {
                    e.innerHTML = "<select><option selected=''></option></select>", e.querySelectorAll("[selected]").length || r.push("\\[" + z + "*(?:checked|disabled|ismap|multiple|readonly|selected|value)"), e.querySelectorAll(":checked").length || r.push(":checked")
                }), se(function(e) {
                    e.innerHTML = "<p test=''></p>", e.querySelectorAll("[test^='']").length && r.push("[*^$]=" + z + "*(?:\"\"|'')"), e.innerHTML = "<input type='hidden'/>", e.querySelectorAll(":enabled").length || r.push(":enabled", ":disabled")
                }), r = new RegExp(r.join("|")), g = function(e, n, i, o, a) {
                    if (!o && !a && !r.test(e)) {
                        var l, u, c = !0,
                            f = j,
                            p = n,
                        ...
                        if (1 === n.nodeType && "object" !== n.nodeName.toLowerCase()) {
                            for (l = s(e), (c = n.getAttribute("id")) ? f = c.replace(/'|\\/g, "\\$&") : n.setAttribute("id", f), f = "[id='" + f + "'] ", u = l.length; u--;) l[u] = f + l[u].join("");
                            p = ne.test(e) && n.parentNode || n, d = l.join(",")
                        }
                        if (d) try {
                            return _.apply(i, q.call(p.querySelectorAll(d), 0)), i
                        } catch (e) {} finally {
                    ...
                    e = o.call(t, "div");
                    try {
                        o.call(t, "[test!='']:sizzle"), i.push("!=", V)
                    } catch (e) {}
                }), i = new RegExp(i.join("|")), n.matchesSelector = function(t, a) {
                    if (a = a.replace(/\=[\x20\t\r\n\f]*([^'"\]]*)[\x20\t\r\n\f]*\]/g, "='$1']"), !w(t) && !i.test(a) && !r.test(a)) try {
                        var s = o.call(t, a);
                        if (s || e || t.document && 11 !== t.document.nodeType) return s
                    } catch (e) {}
                    return n(a, null, null, [t]).length > 0
                })
    ...
    K.fn.extend({
        ...
        is: function(e) {
            return !!e && ("string" == typeof e ? je.test(e) ? K(e, this.context).index(this[0]) >= 0 : K.filter(e, this).length > 0 : this.filter(e).length > 0)
        },
        closest: function(e, t) {
            for (var n, r = 0, i = this.length, o = [], a = je.test(e) || "string" != typeof e ? K(e, t || this.context) : 0; r < i; r++)
        ...
        K.fn[e] = function(n, r) {
            ...
            return Ee.test(e) || (r = n), r && "string" == typeof r && (i = K.filter(r, i)), i = this.length > 1 && !De[e] ? K.unique(i) : i, this.length > 1 && Se.test(e) && (i = i.reverse()), this.pushStack(i, e, Y.call(arguments).join(","))
        }
    }), K.extend({
    ...
    var Le = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
        ...
        ze = c(R),
        Xe = ze.appendChild(R.createElement("div"));
    Ie.optgroup = Ie.option, Ie.tbody = Ie.tfoot = Ie.colgroup = Ie.caption = Ie.thead, Ie.th = Ie.td, K.support.htmlSerialize || (Ie._default = [1, "X<div>", "</div>"]), K.fn.extend({
            text: function(e) {
            ...
            html: function(e) {
                return K.access(this, function(e) {
                    ...
                    if ("string" == typeof e && !qe.test(e) && (K.support.htmlSerialize || !We.test(e)) && (K.support.leadingWhitespace || !He.test(e)) && !Ie[(Me.exec(e) || ["", ""])[1].toLowerCase()]) {
                        e = e.replace(Fe, "<$1></$2>");
                        try {
            ...
            domManip: function(e, n, r) {
                ...
                var i, o, a, s, l = 0,
                    ...
                    c = [],
                    p = this.length;
                if (!K.support.checkClone && p > 1 && "string" == typeof u && Re.test(u)) return this.each(function() {
                ...
                if (this[0]) {
                    ...
                    a = o = null, c.length && K.each(c, function(e, t) {
                        t.src ? K.ajax ? K.ajax({
                            ...
                            global: !1,
                            throws: !0
                        }) : K.error("no ajax") : K.globalEval((t.text || t.textContent || t.innerHTML || "").replace(/^\s*<!(?:\[CDATA\[|\-\-)|[\]\-]{2}>\s*$/g, "")), t.parentNode && t.parentNode.removeChild(t)
                    })
                }
                return this
            }
            ...
            var i, o, a, s = e[0];
            return n = n || R, n = !n.nodeType && n[0] || n, n = n.ownerDocument || n, 1 === e.length && "string" == typeof s && s.length < 512 && n === R && "<" === s.charAt(0) && !Be.test(s) && (K.support.checkClone || !Re.test(s)) && (K.support.html5Clone || !We.test(s)) && (o = !0, i = K.fragments[s], a = i !== t), i || (i = n.createDocumentFragment(), K.clean(e, n, i, r), o && (K.fragments[s] = a && i)), {
                fragment: i,
                cacheable: o
            }
        }, K.fragments = {}, K.each({
            ...
            clone: function(e, t, n) {
                var r, i, o, a;
                if (K.support.html5Clone || K.isXMLDoc(e) || !We.test("<" + e.nodeName + ">") ? a = e.cloneNode(!0) : (Xe.innerHTML = e.outerHTML, Xe.removeChild(a = Xe.firstChild)), !(K.support.noCloneEvent && K.support.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || K.isXMLDoc(e)))
            ...
            clean: function(e, t, n, r) {
                var i, o, a, s, l, u, f, p, d, h, m, y = t === R && ze,
                    v = [];
                for (t && void 0 !== t.createDocumentFragment || (t = R), i = 0; null != (a = e[i]); i++)
                    if ("number" == typeof a && (a += ""), a) {
                        if ("string" == typeof a)
                            if (_e.test(a)) {
                                for (y = y || c(t), f = t.createElement("div"), y.appendChild(f), a = a.replace(Fe, "<$1></$2>"), s = (Me.exec(a) || ["", ""])[1].toLowerCase(), l = Ie[s] || Ie._default, u = l[0], f.innerHTML = l[1] + a + l[2]; u--;) f = f.lastChild;
                                if (!K.support.tbody)
                                    for (p = Oe.test(a), d = "table" !== s || p ? "<table>" !== l[1] || p ? [] : f.childNodes : f.firstChild && f.firstChild.childNodes, o = d.length - 1; o >= 0; --o) K.nodeName(d[o], "tbody") && !d[o].childNodes.length && d[o].parentNode.removeChild(d[o]);
                                !K.support.leadingWhitespace && He.test(a) && f.insertBefore(t.createTextNode(He.exec(a)[0]), f.firstChild), a = f.childNodes, f.parentNode.removeChild(f)
                ...
                if (n)
                    for (h = function(e) {
                            if (!e.type || $e.test(e.type)) return r ? r.push(e.parentNode ? e.parentNode.removeChild(e) : e) : n.appendChild(e)
    ...
    var Ue, Ye, Ve, Je = /alpha\([^)]*\)/i,
        Ge = /opacity=([^)]*)/,
        Qe = /^(top|right|bottom|left)$/,
        Ke = /^(none|table(?!-c[ea]).+)/,
        Ze = /^margin/,
        et = new RegExp("^(" + Z + ")(.*)$", "i"),
        tt = new RegExp("^(" + Z + ")(?!px)[a-z%]+$", "i"),
        nt = new RegExp("^([-+])=(" + Z + ")", "i"),
        rt = {
            BODY: "block"
        },
    ...
    K.fn.extend({
        ...
        toggle: function(e, t) {
            ...
            return K.isFunction(e) && K.isFunction(t) ? lt.apply(this, arguments) : this.each(function() {
        ...
        style: function(e, n, r, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                if ("string" === (a = typeof r) && (o = nt.exec(r)) && (r = (o[1] + 1) * o[2] + parseFloat(K.css(e, n)), a = "number"), !(null == r || "number" === a && isNaN(r) || ("number" === a && !K.cssNumber[l] && (r += "px"), s && "set" in s && (r = s.set(e, r, i)) === t))) try {
                    u[n] = r
                } catch (e) {}
            }
        },
        css: function(e, n, r, i) {
            var o, a, s, l = K.camelCase(n);
            return n = K.cssProps[l] || (K.cssProps[l] = m(e.style, l)), s = K.cssHooks[n] || K.cssHooks[l], s && "get" in s && (o = s.get(e, !0, i)), o === t && (o = Ue(e, n)), "normal" === o && n in ot && (o = ot[n]), r || i !== t ? (a = parseFloat(o), r || K.isNumeric(a) ? a || 0 : o) : o
        },
        swap: function(e, t, n) {
            var r, i, o = {};
    ...
    }), e.getComputedStyle ? Ue = function(t, n) {
        var r, i, o, a, s = e.getComputedStyle(t, null),
            l = t.style;
        return s && (r = s.getPropertyValue(n) || s[n], "" === r && !K.contains(t.ownerDocument, t) && (r = K.style(t, n)), tt.test(r) && Ze.test(n) && (i = l.width, o = l.minWidth, a = l.maxWidth, l.minWidth = l.maxWidth = l.width = r, r = s.width, l.width = i, l.minWidth = o, l.maxWidth = a)), r
    } : R.documentElement.currentStyle && (Ue = function(e, t) {
        var n, r, i = e.currentStyle && e.currentStyle[t],
            o = e.style;
        return null == i && o && o[t] && (i = o[t]), tt.test(i) && !Qe.test(t) && (n = o.left, r = e.runtimeStyle && e.runtimeStyle.left, r && (e.runtimeStyle.left = e.currentStyle.left), o.left = "fontSize" === t ? "1em" : i, i = o.pixelLeft + "px", o.left = n, r && (e.runtimeStyle.left = r)), "" === i ? "auto" : i
    }), K.each(["height", "width"], function(e, t) {
        K.cssHooks[t] = {
            get: function(e, n, r) {
                if (n) return 0 === e.offsetWidth && Ke.test(Ue(e, "display")) ? K.swap(e, it, function() {
                    return w(e, t, r)
                }) : w(e, t, r)
            },
            set: function(e, n, r) {
        ...
        set: function(e, t) {
            ...
            n.zoom = 1, t >= 1 && "" === K.trim(o.replace(Je, "")) && n.removeAttribute && (n.removeAttribute("filter"), r && !r.filter) || (n.filter = Je.test(o) ? o.replace(Je, i) : o + " " + i)
        }
    }), K(function() {
        K.support.reliableMarginRight || (K.cssHooks.marginRight = {
            ...
            K.cssHooks[t] = {
                get: function(e, n) {
                    if (n) {
                        var r = Ue(e, t);
                        return tt.test(r) ? K(e).position()[t] + "px" : r
                    }
                }
            }
        })
    }), K.expr && K.expr.filters && (K.expr.filters.hidden = function(e) {
        return 0 === e.offsetWidth && 0 === e.offsetHeight || !K.support.reliableHiddenOffsets && "none" === (e.style && e.style.display || Ue(e, "display"))
    ...
    K.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                return this.name && !this.disabled && (this.checked || ft.test(this.nodeName) || ct.test(this.type))
            }).map(function(e, t) {
                var n = K(this).val();
    ...
    try {
        ...
        dt = R.createElement("a"), dt.href = "", dt = dt.href
    }
    pt = vt.exec(dt.toLowerCase()) || [], K.fn.load = function(e, n, r) {
        ...
        return l >= 0 && (i = e.slice(l, e.length), e = e.slice(0, l)), K.isFunction(n) ? (r = n, n = t) : n && "object" == typeof n && (o = "POST"), K.ajax({
            ...
            a = arguments, s.html(i ? K("<div>").append(e.replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, "")).find(i) : e)
        }), this
        ...
        ajax: function(e, n) {
            function r(e, n, r, a) {
                var u, f, v, b, w, N = n;
                2 !== x && (x = 2, l && clearTimeout(l), s = t, o = a || "", T.readyState = e > 0 ? 4 : 0, r && (b = S(p, T, r)), e >= 200 && e < 300 || 304 === e ? (p.ifModified && (w = T.getResponseHeader("Last-Modified"), w && (K.lastModified[i] = w), (w = T.getResponseHeader("Etag")) && (K.etag[i] = w)), 304 === e ? (N = "notmodified", u = !0) : (u = A(p, b), N = u.state, f = u.data, v = u.error, u = !v)) : (v = N, N && !e || (N = "error", e < 0 && (e = 0))), T.status = e, T.statusText = (n || N) + "", u ? g.resolveWith(d, [f, N, T]) : g.rejectWith(d, [T, N, v]), T.statusCode(y), y = t, c && h.trigger("ajax" + (u ? "Success" : "Error"), [T, p, u ? f : v]), m.fireWith(d, [T, N]), c && (h.trigger("ajaxComplete", [T, p]), --K.active || K.event.trigger("ajaxStop")))
            }
            ...
            var i, o, a, s, l, u, c, f, p = K.ajaxSetup({}, n),
                ...
                T = {
                    ...
                    getResponseHeader: function(e) {
                        ...
                        if (2 === x) {
                            if (!a)
                                for (a = {}; n = ht.exec(o);) a[n[1].toLowerCase()] = n[2];
                            n = a[e.toLowerCase()]
                        }
                        return n === t ? null : n
                    },
            ...
            if (g.promise(T), T.success = T.done, T.error = T.fail, T.complete = m.add, T.statusCode = function(e) {
                    ...
                    return this
                }, p.url = ((e || p.url) + "").replace(/#.*$/, "").replace(/^\/\//, pt[1] + "//"), p.dataTypes = K.trim(p.dataType || "*").toLowerCase().split(te), null == p.crossDomain && (u = vt.exec(p.url.toLowerCase()), p.crossDomain = !(!u || u[1] === pt[1] && u[2] === pt[2] && (u[3] || ("http:" === u[1] ? 80 : 443)) == (pt[3] || ("http:" === pt[1] ? 80 : 443)))), p.data && p.processData && "string" != typeof p.data && (p.data = K.param(p.data, p.traditional)), k(xt, p, n, T), 2 === x) return T;
            if (c = p.global, p.type = p.type.toUpperCase(), p.hasContent = !mt.test(p.type), c && 0 == K.active++ && K.event.trigger("ajaxStart"), !p.hasContent && (p.data && (p.url += (yt.test(p.url) ? "&" : "?") + p.data, delete p.data), i = p.url, !1 === p.cache)) {
                var N = K.now(),
                    C = p.url.replace(/([?&])_=[^&]*/, "$1_=" + N);
                p.url = C + (C === p.url ? (yt.test(p.url) ? "&" : "?") + "_=" + N : "")
            }(p.data && p.hasContent && !1 !== p.contentType || n.contentType) && T.setRequestHeader("Content-Type", p.contentType), p.ifModified && (i = i || p.url, K.lastModified[i] && T.setRequestHeader("If-Modified-Since", K.lastModified[i]), K.etag[i] && T.setRequestHeader("If-None-Match", K.etag[i])), T.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + Tt + "; q=0.01" : "") : p.accepts["*"]);
    ...
    K.ajaxSetup({
        ...
        var o, a, s, l = n.data,
            ...
            c = !1 !== n.jsonp,
            f = c && kt.test(u),
            p = c && !f && "string" == typeof l && !(n.contentType || "").indexOf("application/x-www-form-urlencoded") && kt.test(l);
        if ("jsonp" === n.dataTypes[0] || f || p) return o = n.jsonpCallback = K.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback, a = e[o], f ? n.url = u.replace(kt, "$1" + o) : p ? n.data = l.replace(kt, "$1" + o) : c && (n.url += (Ct.test(u) ? "&" : "?") + n.jsonp + "=" + o), n.converters["script json"] = function() {
            return s || K.error(o + " was not called"), s[0]
        }, n.dataTypes[0] = "json", e[o] = function() {
            s = arguments
        }, i.always(function() {
            e[o] = a, n[o] && (n.jsonpCallback = r.jsonpCallback, Nt.push(o)), s && K.isFunction(a) && a(s[0]), s = a = t
        }), "script"
    }), K.ajaxSetup({
        accepts: {
    ...
    var St, At = !!e.ActiveXObject && function() {
                        ...
                        l.send(n.hasContent && n.data || null), r = function(e, i) {
                            ...
                            try {
                                if (r && (i || 4 === l.readyState))
                                    if (r = t, a && (l.onreadystatechange = K.noop, At && delete St[a]), i) 4 !== l.readyState && l.abort();
                                    else {
                            ...
                            f && o(s, u, f, c)
                        }, n.async ? 4 === l.readyState ? setTimeout(r, 0) : (a = ++jt, At && (St || (St = {}, K(e).unload(At)), St[a] = r), l.onreadystatechange = r) : r()
                    },
                    abort: function() {
                        r && r(0, 1)
                    }
        ...
        _t = {
            "*": [function(e, t) {
                var n, r, i = this.createTween(e, t),
                    ...
                    u = 20;
                if (o) {
                    if (n = +o[2], "px" !== (r = o[3] || (K.cssNumber[e] ? "" : "px")) && s) {
    ...
    K.Animation = K.extend(F, {
        tweener: function(e, t) {
            ...
            for (var n, r = 0, i = e.length; r < i; r++) n = e[r], _t[n] = _t[n] || [], _t[n].unshift(t)
        },
        ...
        var e, n = K.timers,
            r = 0;
        for (Dt = K.now(); r < n.length; r++) !(e = n[r])() && n[r] === e && n.splice(r--, 1);
        n.length || K.fx.stop(), Dt = t
    }, K.fx.timer = function(e) {
        e() && K.timers.push(e) && !Lt && (Lt = setInterval(K.fx.tick, K.fx.interval))
    ...
    K.fn.offset = function(e) {
        ...
        var n, r, i, o, a, s, l, u = {
            ...
            c = this[0],
            f = c && c.ownerDocument;
        if (f) return (r = f.body) === c ? K.offset.bodyOffset(c) : (n = f.documentElement, K.contains(n, c) ? (void 0 !== c.getBoundingClientRect && (u = c.getBoundingClientRect()), i = B(f), o = n.clientTop || r.clientTop || 0, a = n.clientLeft || r.clientLeft || 0, s = i.pageYOffset || n.scrollTop, l = i.pageXOffset || n.scrollLeft, {
            top: u.top + s - o,
            left: u.left + l - a
        }) : u)
    }, K.offset = {
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var e = this.offsetParent || R.body; e && !qt.test(e.nodeName) && "static" === K.css(e, "position");) e = e.offsetParent;
                return e || R.body
            })
        }
    }), K.each({
