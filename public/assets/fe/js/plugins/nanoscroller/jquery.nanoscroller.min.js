! function(t) {
    ...
    "use strict";
    var s, o, n, l, r, h, c, a, p, d, u, g, v, f, S, m, T, y, b, w, x, $, C, H, O;
    y = {
        paneClass: "nano-pane",
        ...
        windowContext: null
    }, f = "scroll", c = "mousedown", a = "mouseenter", p = "mousemove", u = "mousewheel", d = "mouseup", v = "resize", r = "drag", h = "enter", m = "up", n = "DOMMouseScroll", l = "down", S = "touchmove", s = "Microsoft Internet Explorer" === e.navigator.appName && /msie 7./i.test(e.navigator.appVersion) && e.ActiveXObject, o = null, $ = e.requestAnimationFrame, T = e.cancelAnimationFrame, H = i.createElement("div").style, O = function() {
        var t, e, i, s;
        for (t = i = 0, s = (e = ["t", "webkitT", "MozT", "msT", "OT"]).length; s > i; t = ++i)
            if (e[t], e[t] + "ransform" in H) return e[t].substr(0, e[t].length - 1);
        return !1
    }(), C = function(t) {
        return !1 !== O && ("" === O ? t : O + t.charAt(0).toUpperCase() + t.substr(1))
    }("transform"), w = !1 !== C, b = function() {
        var t, e, s;
        return (e = (t = i.createElement("div")).style).position = "absolute", e.width = "100px", e.height = "100px", e.overflow = f, e.top = "-9999px", i.body.appendChild(t), s = t.offsetWidth - t.clientWidth, i.body.removeChild(t), s
    }, x = function() {
        var t, i, s;
        ...
        return g.prototype.preventScrolling = function(t, e) {
            if (this.isActive)
                if (t.type === n)(e === l && t.originalEvent.detail > 0 || e === m && t.originalEvent.detail < 0) && t.preventDefault();
                else if (t.type === u) {
            ...
            var t, e;
            w ? (t = {})[C] = "translate(0, " + this.sliderTop + "px)" : t = {
                top: this.sliderTop
            }, $ ? (T && this.scrollRAF && T(this.scrollRAF), this.scrollRAF = $((e = this, function() {
            ...
            this.events = {
                down: (t = this, function(e) {
                    return t.isBeingDragged = !0, t.offsetY = e.pageY - t.slider.offset().top, t.slider.is(e.target) || (t.offsetY = 0), t.pane.addClass(t.options.activeClass), t.doc.bind(p, t.events[r]).bind(d, t.events.up), t.body.bind(a, t.events[h]), !1
                }),
                drag: function(t) {
                    return function(e) {
                ...
                up: function(t) {
                    return function(e) {
                        return t.isBeingDragged = !1, t.pane.removeClass(t.options.activeClass), t.doc.unbind(p, t.events[r]).unbind(d, t.events.up), t.body.unbind(a, t.events[h]), !1
                    }
                }(this),
                resize: function(t) {
                    return function(e) {
            ...
            var t;
            this.removeEvents(), t = this.events, this.options.disableResize || this.win.bind(v, t[v]), this.iOSNativeScrolling || (this.slider.bind(c, t[l]), this.pane.bind(c, t.panedown).bind(u + " " + n, t.wheel)), this.$content.bind(f + " " + u + " " + n + " " + S, t[f])
        }, g.prototype.removeEvents = function() {
            var t;
            t = this.events, this.win.unbind(v, t[v]), this.iOSNativeScrolling || (this.slider.unbind(), this.pane.unbind()), this.$content.unbind(f + " " + u + " " + n + " " + S, t[f])
        }, g.prototype.generate = function() {
            var t, i, s, n, l;
            return n = (i = this.options).paneClass, l = i.sliderClass, i.contentClass, (s = this.$el.children("." + n)).length || s.children("." + l).length || this.$el.append('<div class="' + n + '"><div class="' + l + '" /></div>'), this.pane = this.$el.children("." + n), this.slider = this.pane.find("." + l), 0 === o && x() ? t = {
                right: -14,
        ...
        return this.each(function() {
            var i, s;
            if ((s = this.nanoscroller) || (i = t.extend({}, y, e), this.nanoscroller = s = new g(this, i)), e && "object" == typeof e) {
