...
@section('content')
    ...
    <section class="content" style="max-width: 1700px; padding: 0 20px; margin: 50px auto;">
        <h1 style="text-align:center; font-size: 54px;">{{__("CÔNG NGHỆ XANH")}}</h1>
        ...
        <h2 style="text-align:justify"><span style="font-size:18pt"><span style="background-color:white"><strong><span
                            style="font-size:14.0pt">{{trans('cms.about_green_tech_1')}}</span></strong></span></span>
        </h2>
        <p style="text-align:justify"><span style="font-size:12pt"><span style="background-color:white"><span
                        style="font-size:14.0pt">{{trans('cms.about_green_tech_2')}}</span></span></span>
        </p>
        <p style="text-align:justify"><span style="font-size:12pt"><span style="background-color:white"><span
                        style="font-size:14.0pt">{{trans('cms.about_green_tech_3')}}</span></span></span>
        </p>
        <p style="text-align:justify"><span style="font-size:12pt"><span style="background-color:white"><strong><span
                            style="font-size:14.0pt">{{trans('cms.about_green_tech_4')}}</span></strong></span></span></p>
        <p style="text-align:justify"><span style="font-size:12pt"><span style="background-color:white"><span
                        style="font-size:14.0pt">{{trans('cms.about_green_tech_5')}}</span></span></span>
        </p>
        <p style="text-align:justify"><span style="font-size:12pt"><span style="background-color:white"><span
                        style="font-size:14.0pt">{{trans('cms.about_green_tech_6')}}</span></span></span>
        </p>
        <p style="text-align:justify"><span style="font-size:12pt"><span style="background-color:white"><span
                        style="font-size:14.0pt">{{trans('cms.about_green_tech_7')}}</span></span></span>
        </p>
        <p style="text-align:justify"><span style="font-size:12pt"><span style="background-color:white"><span
                        style="font-size:14.0pt">{{trans('cms.about_green_tech_8')}}</span></span></span>
        </p>
        <p style="text-align:justify"><span style="font-size:12pt"><span style="background-color:white"><span
                        style="font-size:14.0pt">{{trans('cms.about_green_tech_9')}}</span></span></span>
        </p>
        <p style="text-align:justify"><span style="font-size:12pt"><span style="background-color:white"><span
        ...
        <p style="text-align:justify"><span style="font-size:12pt"><span style="background-color:white"><span
                        style="font-size:14.0pt">{{trans('cms.about_green_tech_12')}}</span></span></span>
        </p>
        <p style="text-align:justify"><span style="font-size:12pt"><span style="background-color:white"><span
                        style="font-size:14.0pt">{{trans('cms.about_green_tech_13')}}</span></span></span>
        </p>
        <p style="text-align:justify"><span style="font-size:12pt"><span style="background-color:white"><span
                        style="font-size:14.0pt">{{trans('cms.about_green_tech_14')}}</span></span></span>
        </p>
        <p style="text-align:justify"><span style="font-size:12pt"><span style="background-color:white"><span
                        style="font-size:14.0pt">{{trans('cms.about_green_tech_15')}}</span></span></span>
        </p>
    </section>
