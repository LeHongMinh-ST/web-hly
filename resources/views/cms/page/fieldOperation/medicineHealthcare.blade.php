...
@section('content')
    ...
    <section class="content" style="max-width: 1700px; padding: 0 20px; margin: 50px auto;">
        <h1 style="text-align:center; font-size: 54px;">{{__("NAM Y CHĂM SÓC SỨC KHỎE")}}</h1>
        ...
        <h2 style="text-align:justify"><span style="font-size:18pt"><span style="background-color:white"><strong><span
                            style="font-size:14.0pt">{{trans('cms.about_VN_medicine_1')}}</span></strong></span></span>
        </h2>
        <p style="text-align:justify"><span style="font-size:12pt"><span style="background-color:white"><span
                        style="font-size:14.0pt">{{trans('cms.about_VN_medicine_2')}}</span></span></span>
        </p>
        <p style="text-align:justify"><span style="font-size:12pt"><span style="background-color:white"><span
                        style="font-size:14.0pt">{{trans('cms.about_VN_medicine_3')}}</span></span></span>
        </p>
        <p style="text-align:justify"><span style="font-size:12pt"><span style="background-color:white"><strong><span
                            style="font-size:14.0pt">{{trans('cms.about_VN_medicine_4')}}</span></strong></span></span></p>
        <p style="text-align:justify"><span style="font-size:12pt"><span style="background-color:white"><span
                        style="font-size:14.0pt">{{trans('cms.about_VN_medicine_5')}}</span></span></span>
        </p>
        <p style="text-align:justify"><span style="font-size:12pt"><span style="background-color:white"><span
                        style="font-size:14.0pt">{{trans('cms.about_VN_medicine_6')}}</span></span></span>
        </p>
        <p style="text-align:justify"><span style="font-size:12pt"><span style="background-color:white"><span
                        style="font-size:14.0pt">{{trans('cms.about_VN_medicine_7')}}</span></span></span>
        </p>
        <p style="text-align:justify"><span style="font-size:12pt"><span style="background-color:white"><span
                        style="font-size:14.0pt">{{trans('cms.about_VN_medicine_8')}}</span></span></span>
        </p>
        <p style="text-align:justify"><span style="font-size:12pt"><span style="background-color:white"><span
                        style="font-size:14.0pt">{{trans('cms.about_VN_medicine_9')}}</span></span></span>
        </p>
        <p style="text-align:justify"><span style="font-size:12pt"><span style="background-color:white"><span
        ...
        <p style="text-align:justify"><span style="font-size:12pt"><span style="background-color:white"><span
                        style="font-size:14.0pt">{{trans('cms.about_VN_medicine_12')}}</span></span></span>
        </p>
        <p style="text-align:justify"><span style="font-size:12pt"><span style="background-color:white"><span
                        style="font-size:14.0pt">{{trans('cms.about_VN_medicine_13')}}</span></span></span>
        </p>
        <p style="text-align:justify"><span style="font-size:12pt"><span style="background-color:white"><span
                        style="font-size:14.0pt">{{trans('cms.about_VN_medicine_14')}}</span></span></span>
        </p>
        <p style="text-align:justify"><span style="font-size:12pt"><span style="background-color:white"><span
                        style="font-size:14.0pt">{{trans('cms.about_VN_medicine_15')}}</span></span></span>
        </p>
    </section>
