...
@section('custom_js')
    @production
        ...
        @endphp
        <script type="module" src="/build/{{ $manifest['resources/js/investmentArticle/index.js']['file'] }}"></script>
        @else
            @vite(['resources/js/investmentArticle/index.js'])
            @endproduction
            @endsection
                                ...
                                <div class="panel panel-flat">
                                    <div class="panel-heading">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <form
                                                    action="{{ route('admin.investment-article.index', array_merge(request()->all())) }}"
                                                    method="get">
                                                    <div class="row">
                                                        <div class="col-md-8">
                                            ...
                                            <div class="col-md-4 text-right">
                                                <div class="form-group has-feedback has-feedback-left"
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-right">
                                                            @foreach(\App\Enums\Language::toSelectArray() as $key => $locale)
                                                                <li>
                                                                    <a href="{{ route('admin.investment-article.index', array_merge(request()->all(), ['locale' => $key])) }}">
                                                                        <img
                                                                            class="icon-flag"
                                                    ...
                                                    @if(checkPermission('post-create'))
                                                        <a type="button" href="{{ route('admin.investment-article.create', ['ref_language' => request()->query('locale', \App\Enums\Language::Vietnamese)]) }}"
                                                                ...
                                                                <li class="dropdown">
                                                                    ...
                                                                    <ul class="dropdown-menu dropdown-menu-right">
                                                                        @if(checkPermission('post-update'))
                                                                            <li>
                                                                                <a href="{{ route('admin.investment-article.edit', $post->id) }}"><i
