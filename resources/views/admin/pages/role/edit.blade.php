            ...
            <div class="page-header-content">
                <div class="page-title">
                    <h4><a href="{{ route('admin.roles.index') }}" class="text-link"><i
                            ...
                            class="text-semibold">Vai trò</span> -
                        Tạo mới </h4>
                </div>
            ...
            <div class="row">
                <form action="{{ route('admin.roles.update', $role->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-9">
                        <div class="panel panel-white">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" name="name" id="title" value="{{ old('name', $role->name) }}"
                                               class="form-control">
                                        @error('title')
                                ...
                                <textarea rows="5" style="resize: vertical" cols="5" name="description"
                                          class="form-control"
                                          aria-required="true">{{ old('description', $role->description) }}</textarea>
                                    </div>
                        ...
                        <div class="panel panel-white">
                            <div class="panel-heading">
                                <h6 class="panel-title"><i class="icon-flag3 position-left"></i> Cờ đánh dấu quyền hạn
                                </h6>
                            </div>
                            <div class="panel-body">
                                <div class="form-group">
                                        ...
                                        @forelse($permissions as $group)
                                            <li class="has">
                                                <input type="checkbox" name="group[]" value="{{ $group->id }}"
                                                       @if(in_array($group->id,$groupCheck)) checked @endif>
