                                    ...
                                    <div class="panel panel-white">
                                        ...
                                        <div class="panel-body">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <input type="text" name="name" id="title" value="{{ old('name', $role->name) }}" class="form-control">
                                                    @error('title')
                                            ...
                                            <div class="form-group">
                                                <ul class="tree">
                                                    @forelse($permissions as $group)
                                                        <li class="has">
                                                            <input type="checkbox" name="group[]" value="{{ $group->id }}" @if(in_array($group->id,$groupCheck)) checked @endif>
